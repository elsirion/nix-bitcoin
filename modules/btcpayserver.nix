...
in {
  ...
  config = mkIf cfg.btcpayserver.enable {
    ...
    systemd.services.btcpayserver = let
      ...
      nbExplorerCookie = "${cfg.nbxplorer.dataDir}/${bitcoind.makeNetworkName "Main" "RegTest" "Signet"}/.cookie";
      configFile = builtins.toFile "config" (''
        network=${bitcoind.network}
      ...
      '' + optionalString (cfg.btcpayserver.lightningBackend == "clightning") ''
        btclightning=type=clightning;server=unix:///${cfg.clightning.dataDir}/${bitcoind.makeNetworkName "bitcoin" "regtest" "signet"}/lightning-rpc
      '' + optionalString cfg.btcpayserver.lbtc ''
        chains=btc,lbtc
